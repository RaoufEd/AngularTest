...
export class GestionComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private route: Router, private current: ActivatedRoute, private crud: CrudService) {
    this.current.params.subscribe(param => this.idProduit = param.id)
  }
